...
export const ParseRuleKindMapping = {
	...
	RULE_relationalExpression: 58,
	RULE_equalityExpression: 59,
	RULE_logicalAndExpression: 60,
	RULE_logicalOrExpression: 61,
	RULE_conditionalExpression: 62,
	RULE_assignmentExpression: 63,
	RULE_assignmentOperator: 64,
	RULE_expression: 65,
	RULE_typeSpecifierExpression: 66,
	RULE_identifierTypeSpecifierExpression: 67,
	RULE_genericTypeSpecifierExpression: 68,
	RULE_typeofTypeSpecifierExpression: 69,
	RULE_typeSpecifierIdentifier: 70,
	// Labelled rules, which don't have a corresponding identifier number in KipperParser.
	RULE_memberAccessExpression: 71, // -> See 'computedPrimaryExpression'
	RULE_functionCallExpression: 72, // -> See 'computedPrimaryExpression'
} as const;
