...
export class KipperParser extends KipperParserBase {
	...
	private static readonly _LITERAL_NAMES: Array<string | undefined> = [
		...
		"'call'", "'->'", "'class'", "'interface'", "'constructor'", "'new'", 
		"'true'", "'false'", "'matches'", "'typeof'", "'void'", "'null'", "'undefined'", 
		"','", "';'", "'?'", "':'", "'('", "')'", "'['", "']'", undefined, "'{'", 
		"'}'", "'+'", "'++'", "'-'", "'--'", "'*'", "'/'", "'%'", "'**'", "'&&'", 
		"'||'", "'!'", "'='", "'+='", "'-='", "'*='", "'/='", "'%='", "'=='", 
		"'!='", "'<'", "'<='", "'>'", "'>='", "'&'", "'|'", "'^'", "'~'", "'<<'", 
	...
	private static readonly _SYMBOLIC_NAMES: Array<string | undefined> = [
		...
		"CallFunc", "RetIndicator", "Class", "Interface", "Constructor", "New", 
		"True", "False", "Matches", "Typeof", "Void", "Null", "Undefined", "Comma", 
		"SemiColon", "QuestionMark", "Colon", "LeftParen", "RightParen", "LeftBracket", 
		"RightBracket", "FStringExpEnd", "LeftBrace", "RightBrace", "Plus", "PlusPlus", 
		"Minus", "MinusMinus", "Star", "Div", "Mod", "PowerTo", "AndAnd", "OrOr", 
		"Not", "Assign", "PlusAssign", "MinusAssign", "StarAssign", "DivAssign", 
		"ModAssign", "Equal", "NotEqual", "Less", "LessEqual", "Greater", "GreaterEqual", 
		"BitwiseAnd", "BitwiseOr", "BitwiseXor", "BitwiseNot", "BitwiseZeroFillLeftShift", 
		"BitwiseSignedRightShift", "BitwiseZeroFillRightShift", "Dot", "Identifier", 
	...
	public forLoopIterationStatement(): ForLoopIterationStatementContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << KipperParser.Const) | (1 << KipperParser.Var) | (1 << KipperParser.CallFunc) | (1 << KipperParser.New) | (1 << KipperParser.True) | (1 << KipperParser.False) | (1 << KipperParser.Typeof))) !== 0) || ((((_la - 32)) & ~0x1F) === 0 && ((1 << (_la - 32)) & ((1 << (KipperParser.Void - 32)) | (1 << (KipperParser.Null - 32)) | (1 << (KipperParser.Undefined - 32)) | (1 << (KipperParser.LeftParen - 32)) | (1 << (KipperParser.LeftBracket - 32)) | (1 << (KipperParser.LeftBrace - 32)) | (1 << (KipperParser.Plus - 32)) | (1 << (KipperParser.PlusPlus - 32)) | (1 << (KipperParser.Minus - 32)) | (1 << (KipperParser.MinusMinus - 32)) | (1 << (KipperParser.Not - 32)))) !== 0) || ((((_la - 72)) & ~0x1F) === 0 && ((1 << (_la - 72)) & ((1 << (KipperParser.BitwiseNot - 72)) | (1 << (KipperParser.Identifier - 72)) | (1 << (KipperParser.IntegerConstant - 72)) | (1 << (KipperParser.SingleQuoteStringLiteral - 72)) | (1 << (KipperParser.DoubleQuoteStringLiteral - 72)) | (1 << (KipperParser.FloatingConstant - 72)) | (1 << (KipperParser.FStringSingleQuoteStart - 72)) | (1 << (KipperParser.FStringDoubleQuoteStart - 72)))) !== 0)) {
				{
				this.state = 383;
				this._errHandler.sync(this);
				switch (this._input.LA(1)) {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (((((_la - 22)) & ~0x1F) === 0 && ((1 << (_la - 22)) & ((1 << (KipperParser.CallFunc - 22)) | (1 << (KipperParser.New - 22)) | (1 << (KipperParser.True - 22)) | (1 << (KipperParser.False - 22)) | (1 << (KipperParser.Typeof - 22)) | (1 << (KipperParser.Void - 22)) | (1 << (KipperParser.Null - 22)) | (1 << (KipperParser.Undefined - 22)) | (1 << (KipperParser.LeftParen - 22)) | (1 << (KipperParser.LeftBracket - 22)) | (1 << (KipperParser.LeftBrace - 22)) | (1 << (KipperParser.Plus - 22)) | (1 << (KipperParser.PlusPlus - 22)) | (1 << (KipperParser.Minus - 22)) | (1 << (KipperParser.MinusMinus - 22)))) !== 0) || ((((_la - 56)) & ~0x1F) === 0 && ((1 << (_la - 56)) & ((1 << (KipperParser.Not - 56)) | (1 << (KipperParser.BitwiseNot - 56)) | (1 << (KipperParser.Identifier - 56)) | (1 << (KipperParser.IntegerConstant - 56)) | (1 << (KipperParser.SingleQuoteStringLiteral - 56)) | (1 << (KipperParser.DoubleQuoteStringLiteral - 56)) | (1 << (KipperParser.FloatingConstant - 56)) | (1 << (KipperParser.FStringSingleQuoteStart - 56)) | (1 << (KipperParser.FStringDoubleQuoteStart - 56)))) !== 0)) {
				{
				this.state = 390;
				this.expression();
	...
	public objectPrimaryExpression(): ObjectPrimaryExpressionContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (((((_la - 77)) & ~0x1F) === 0 && ((1 << (_la - 77)) & ((1 << (KipperParser.Identifier - 77)) | (1 << (KipperParser.SingleQuoteStringLiteral - 77)) | (1 << (KipperParser.DoubleQuoteStringLiteral - 77)))) !== 0)) {
				{
				this.state = 520;
				this.objectProperty();
				this.state = 525;
	...
	public voidOrNullOrUndefinedPrimaryExpression(): VoidOrNullOrUndefinedPrimaryExpressionContext {
		...
		try {
			...
			this.state = 539;
			_la = this._input.LA(1);
			if (!(((((_la - 32)) & ~0x1F) === 0 && ((1 << (_la - 32)) & ((1 << (KipperParser.Void - 32)) | (1 << (KipperParser.Null - 32)) | (1 << (KipperParser.Undefined - 32)))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public unaryOperator(): UnaryOperatorContext {
		...
		try {
			...
			this.state = 640;
			_la = this._input.LA(1);
			if (!(((((_la - 46)) & ~0x1F) === 0 && ((1 << (_la - 46)) & ((1 << (KipperParser.Plus - 46)) | (1 << (KipperParser.Minus - 46)) | (1 << (KipperParser.Not - 46)) | (1 << (KipperParser.BitwiseNot - 46)))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
		...
		try {
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.state = 653;
					_la = this._input.LA(1);
					if (!(((((_la - 50)) & ~0x1F) === 0 && ((1 << (_la - 50)) & ((1 << (KipperParser.Star - 50)) | (1 << (KipperParser.Div - 50)) | (1 << (KipperParser.Mod - 50)) | (1 << (KipperParser.PowerTo - 50)))) !== 0))) {
					this._errHandler.recoverInline(this);
					} else {
						if (this._input.LA(1) === Token.EOF) {
							this.matchedEOF = true;
	...
	public bitwiseShiftOperators(): BitwiseShiftOperatorsContext {
		...
		try {
			...
			this.state = 683;
			_la = this._input.LA(1);
			if (!(((((_la - 73)) & ~0x1F) === 0 && ((1 << (_la - 73)) & ((1 << (KipperParser.BitwiseZeroFillLeftShift - 73)) | (1 << (KipperParser.BitwiseSignedRightShift - 73)) | (1 << (KipperParser.BitwiseZeroFillRightShift - 73)))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
		...
		try {
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.state = 689;
					_la = this._input.LA(1);
					if (!(((((_la - 65)) & ~0x1F) === 0 && ((1 << (_la - 65)) & ((1 << (KipperParser.Less - 65)) | (1 << (KipperParser.LessEqual - 65)) | (1 << (KipperParser.Greater - 65)) | (1 << (KipperParser.GreaterEqual - 65)))) !== 0))) {
					this._errHandler.recoverInline(this);
					} else {
						if (this._input.LA(1) === Token.EOF) {
							this.matchedEOF = true;
	...
	public assignmentOperator(): AssignmentOperatorContext {
		...
		try {
			...
			this.state = 778;
			_la = this._input.LA(1);
			if (!(((((_la - 57)) & ~0x1F) === 0 && ((1 << (_la - 57)) & ((1 << (KipperParser.Assign - 57)) | (1 << (KipperParser.PlusAssign - 57)) | (1 << (KipperParser.MinusAssign - 57)) | (1 << (KipperParser.StarAssign - 57)) | (1 << (KipperParser.DivAssign - 57)) | (1 << (KipperParser.ModAssign - 57)))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public genericTypeSpecifierExpression(): GenericTypeSpecifierExpressionContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (((((_la - 31)) & ~0x1F) === 0 && ((1 << (_la - 31)) & ((1 << (KipperParser.Typeof - 31)) | (1 << (KipperParser.Void - 31)) | (1 << (KipperParser.Null - 31)) | (1 << (KipperParser.Undefined - 31)))) !== 0) || _la === KipperParser.Identifier) {
				{
				this.state = 797;
				this.typeSpecifierExpression();
				this.state = 802;
	...
	public typeSpecifierIdentifier(): TypeSpecifierIdentifierContext {
		...
		try {
			...
			this.state = 814;
			_la = this._input.LA(1);
			if (!(((((_la - 32)) & ~0x1F) === 0 && ((1 << (_la - 32)) & ((1 << (KipperParser.Void - 32)) | (1 << (KipperParser.Null - 32)) | (1 << (KipperParser.Undefined - 32)))) !== 0) || _la === KipperParser.Identifier)) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
