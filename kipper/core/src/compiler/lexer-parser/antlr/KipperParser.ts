...
export class KipperParser extends KipperParserBase {
	...
	public static readonly ruleNames: string[] = [
		...
		"doWhileLoopIterationStatement", "jumpStatement", "returnStatement", "tryCatchStatement", 
		"tryClause", "catchClause", "errorBindingDeclaration", "finallyClause", 
		"primaryExpression", "lambdaPrimaryExpression", "tangledPrimaryExpression", 
		...
		"postfixExpression", "incrementOrDecrementPostfixExpression", "typeofExpression", 
		...
		"convertExpression", "castExpression", "forceCastExpression", "tryCastExpression", 
		"multiplicativeExpression", "additiveExpression", "bitwiseShiftExpression", 
		"bitwiseShiftOperators", "instanceOfExpression", "matchesExpression", 
		...
		"genericTypeSpecifierExpression", "typeofTypeSpecifierExpression", "nullableTypeSpecifierExpression", 
	...
	public forLoopIterationStatement(): ForLoopIterationStatementContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (((((_la - 26)) & ~0x1F) === 0 && ((1 << (_la - 26)) & ((1 << (KipperParser.CallFunc - 26)) | (1 << (KipperParser.New - 26)) | (1 << (KipperParser.True - 26)) | (1 << (KipperParser.False - 26)) | (1 << (KipperParser.Typeof - 26)) | (1 << (KipperParser.Void - 26)) | (1 << (KipperParser.Null - 26)) | (1 << (KipperParser.Undefined - 26)) | (1 << (KipperParser.LeftParen - 26)) | (1 << (KipperParser.LeftBracket - 26)) | (1 << (KipperParser.LeftBrace - 26)) | (1 << (KipperParser.Plus - 26)) | (1 << (KipperParser.PlusPlus - 26)) | (1 << (KipperParser.Minus - 26)) | (1 << (KipperParser.MinusMinus - 26)))) !== 0) || ((((_la - 64)) & ~0x1F) === 0 && ((1 << (_la - 64)) & ((1 << (KipperParser.Not - 64)) | (1 << (KipperParser.BitwiseNot - 64)) | (1 << (KipperParser.Identifier - 64)) | (1 << (KipperParser.IntegerConstant - 64)) | (1 << (KipperParser.SingleQuoteStringLiteral - 64)) | (1 << (KipperParser.DoubleQuoteStringLiteral - 64)) | (1 << (KipperParser.FloatingConstant - 64)) | (1 << (KipperParser.FStringSingleQuoteStart - 64)) | (1 << (KipperParser.FStringDoubleQuoteStart - 64)))) !== 0)) {
				{
				this.state = 422;
				this.expression();
	...
	public objectPrimaryExpression(): ObjectPrimaryExpressionContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (((((_la - 85)) & ~0x1F) === 0 && ((1 << (_la - 85)) & ((1 << (KipperParser.Identifier - 85)) | (1 << (KipperParser.SingleQuoteStringLiteral - 85)) | (1 << (KipperParser.DoubleQuoteStringLiteral - 85)))) !== 0)) {
				{
				this.state = 582;
				this.objectProperty();
				this.state = 587;
	...
	public voidOrNullOrUndefinedPrimaryExpression(): VoidOrNullOrUndefinedPrimaryExpressionContext {
		...
		try {
			...
			this.state = 601;
			_la = this._input.LA(1);
			if (!(((((_la - 39)) & ~0x1F) === 0 && ((1 << (_la - 39)) & ((1 << (KipperParser.Void - 39)) | (1 << (KipperParser.Null - 39)) | (1 << (KipperParser.Undefined - 39)))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public unaryOperator(): UnaryOperatorContext {
		...
		try {
			...
			this.state = 704;
			_la = this._input.LA(1);
			if (!(((((_la - 54)) & ~0x1F) === 0 && ((1 << (_la - 54)) & ((1 << (KipperParser.Plus - 54)) | (1 << (KipperParser.Minus - 54)) | (1 << (KipperParser.Not - 54)) | (1 << (KipperParser.BitwiseNot - 54)))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
		...
		try {
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.state = 733;
					_la = this._input.LA(1);
					if (!(((((_la - 58)) & ~0x1F) === 0 && ((1 << (_la - 58)) & ((1 << (KipperParser.Star - 58)) | (1 << (KipperParser.Div - 58)) | (1 << (KipperParser.Mod - 58)) | (1 << (KipperParser.PowerTo - 58)))) !== 0))) {
					this._errHandler.recoverInline(this);
					} else {
						if (this._input.LA(1) === Token.EOF) {
							this.matchedEOF = true;
	...
	public bitwiseShiftOperators(): BitwiseShiftOperatorsContext {
		...
		try {
			...
			this.state = 763;
			_la = this._input.LA(1);
			if (!(((((_la - 81)) & ~0x1F) === 0 && ((1 << (_la - 81)) & ((1 << (KipperParser.BitwiseZeroFillLeftShift - 81)) | (1 << (KipperParser.BitwiseSignedRightShift - 81)) | (1 << (KipperParser.BitwiseZeroFillRightShift - 81)))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
		...
		try {
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.state = 791;
					_la = this._input.LA(1);
					if (!(((((_la - 73)) & ~0x1F) === 0 && ((1 << (_la - 73)) & ((1 << (KipperParser.Less - 73)) | (1 << (KipperParser.LessEqual - 73)) | (1 << (KipperParser.Greater - 73)) | (1 << (KipperParser.GreaterEqual - 73)))) !== 0))) {
					this._errHandler.recoverInline(this);
					} else {
						if (this._input.LA(1) === Token.EOF) {
							this.matchedEOF = true;
	...
	public assignmentOperator(): AssignmentOperatorContext {
		...
		try {
			...
			this.state = 880;
			_la = this._input.LA(1);
			if (!(((((_la - 65)) & ~0x1F) === 0 && ((1 << (_la - 65)) & ((1 << (KipperParser.Assign - 65)) | (1 << (KipperParser.PlusAssign - 65)) | (1 << (KipperParser.MinusAssign - 65)) | (1 << (KipperParser.StarAssign - 65)) | (1 << (KipperParser.DivAssign - 65)) | (1 << (KipperParser.ModAssign - 65)))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public nullableTypeSpecifierExpression(): NullableTypeSpecifierExpressionContext {
		let _localctx: NullableTypeSpecifierExpressionContext = new NullableTypeSpecifierExpressionContext(this._ctx, this.state);
	...
	public typeSpecifierIdentifier(): TypeSpecifierIdentifierContext {
		...
		try {
			...
			this.state = 924;
			_la = this._input.LA(1);
			if (!(((((_la - 39)) & ~0x1F) === 0 && ((1 << (_la - 39)) & ((1 << (KipperParser.Void - 39)) | (1 << (KipperParser.Null - 39)) | (1 << (KipperParser.Undefined - 39)))) !== 0) || _la === KipperParser.Identifier)) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
...
export class TryCatchStatementContext extends KipperParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return KipperParser.RULE_tryCatchStatement; }
	// @Override
	public enterRule(listener: KipperParserListener): void {
...
export class TryClauseContext extends KipperParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return KipperParser.RULE_tryClause; }
	// @Override
	public enterRule(listener: KipperParserListener): void {
...
export class ErrorBindingDeclarationContext extends KipperParserRuleContext {
	...
	public Colon(): TerminalNode | undefined { return this.tryGetToken(KipperParser.Colon, 0); }
	...
	// @Override
	public get ruleIndex(): number { return KipperParser.RULE_errorBindingDeclaration; }
	// @Override
	public enterRule(listener: KipperParserListener): void {
...
export class NullableTypeSpecifierExpressionContext extends KipperParserRuleContext {
	public QuestionMark(): TerminalNode | undefined { return this.tryGetToken(KipperParser.QuestionMark, 0); }
	public DoubleQuestionMark(): TerminalNode | undefined { return this.tryGetToken(KipperParser.DoubleQuestionMark, 0); }
	public identifierTypeSpecifierExpression(): IdentifierTypeSpecifierExpressionContext | undefined {
		return this.tryGetRuleContext(0, IdentifierTypeSpecifierExpressionContext);
	}
	public genericTypeSpecifierExpression(): GenericTypeSpecifierExpressionContext | undefined {
	...
	// @Override
	public get ruleIndex(): number { return KipperParser.RULE_nullableTypeSpecifierExpression; }
	// @Override
	public enterRule(listener: KipperParserListener): void {
