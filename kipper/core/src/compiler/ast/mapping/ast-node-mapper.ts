...
export class ASTNodeMapper {
	...
	public static readonly expressionKindToClassMap = {
		...
		[ParseRuleKindMapping.RULE_convertExpression]: ConvertExpression,
		[ParseRuleKindMapping.RULE_castExpression]: CastExpression,
		[ParseRuleKindMapping.RULE_forceCastExpression]: ForceCastExpression,
		[ParseRuleKindMapping.RULE_tryCastExpression]: TryCastExpression,
	...
	public static readonly expressionKindToRuleContextMap = {
		...
		[ParseRuleKindMapping.RULE_castExpression]: CastExpressionContext,
		[ParseRuleKindMapping.RULE_convertExpression]: ConvertExpressionContext,
		[ParseRuleKindMapping.RULE_forceCastExpression]: ForceCastExpressionContext,
		[ParseRuleKindMapping.RULE_tryCastExpression]: TryCastExpressionContext,
	...
	public static readonly expressionRuleNameToClassMap = {
		...
		RULE_castExpression: CastExpression,
		RULE_convertExpression: ConvertExpression,
		RULE_forceCastExpression: ForceCastExpression,
		RULE_tryCastExpression: TryCastExpression,
