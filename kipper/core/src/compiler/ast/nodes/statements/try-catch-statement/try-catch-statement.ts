/**
 * Try-Catch statement class, which represents try-catch-finally statements in the Kipper language and is compilable using
...
import type { TryCatchStatementSemantics } from "./try-catch-statement-sematics";
 ...
 * {@link translateCtxAndChildren}.
 */
export class IfStatement extends Statement<TryCatchStatementSemantics, TryCatchStatementTypeSemantics> {
	/**
