 ...
 * 39 as str // "39"
 */
import type { ConvertExpressionSemantics } from "./convert-expression-semantics";
import type { ConvertExpressionTypeSemantics } from "./convert-expression-type-semantics";
import type { CompilableASTNode } from "../../../../compilable-ast-node";
import type { IdentifierTypeSpecifierExpression } from "../../type-specifier-expression";
import type { Expression } from "../../expression";
import type { ConvertExpressionContext } from "../../../../../lexer-parser";
 ...
 * 39 as str // "39"
 */
export class ConvertExpression extends CastOrConvertExpression<
...
> {
	 ...
	 * @since 0.11.0
	 */
	public static readonly kind = ParseRuleKindMapping.RULE_convertExpression;
	 ...
	 * @private
	 */
	protected override readonly _antlrRuleCtx: ConvertExpressionContext;

	constructor(antlrRuleCtx: ConvertExpressionContext, parent: CompilableASTNode) {
	...
	public override get ruleName() {
		return ConvertExpression.ruleName;
	}

	/**
	 * The antlr context containing the antlr4 metadata for this expression.
	 */
	public override get antlrRuleCtx(): ConvertExpressionContext {
	...
	readonly targetSemanticAnalysis = this.semanticAnalyser.convertExpression;
	readonly targetCodeGenerator = this.codeGenerator.convertExpression;
}
