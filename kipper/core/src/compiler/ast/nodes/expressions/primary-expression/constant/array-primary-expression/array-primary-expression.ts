...
import { ArrayPrimaryExpressionContext, KindParseRuleMapping, ParseRuleKindMapping } from "../../../../../../parser";
 ...
 * @since 0.1.0
 */
export class ArrayPrimaryExpression extends ConstantExpression<
