/**
 * Type specifier expression module containing the classes representing expressions, which are used in declaration
 * and type references, where a type specifier is required.
 * @since 0.11.0
 */
