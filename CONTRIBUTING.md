...
writing semantic analysis and check functions anywhere outside those functions and the target specific semantics!
...
`/test/` folder of Kipper. The tests are categorised into sub-folders per package in the following scheme:
