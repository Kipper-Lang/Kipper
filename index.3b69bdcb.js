...
})({"782y4":[function(require,module,exports) {
/**
...
const searchOverlay = document.getElementById("search-result-overlay");
...
async function search(searchBar, searchBarInput) {
    ...
    if (searchInput) {
        const pageResults = (()=>{
            const results = [];
            for (const page of (0, _searchIndex.searchIndex)){
        ...
        if (pageResults.length > 0) {
            ...
            for (const result of pageResults){
                // @ts-ignore
                const link = (0, _main.isDocsFile) ? `..${result.uriPath}` : `.${result.uriPath}`;
...
async function loadSearch() {
    ...
    if (Array.isArray((0, _searchIndex.searchIndex)) && (0, _searchIndex.searchIndex).length > 0) console.log("Index initialised!");
    else {
    ...
    document.querySelectorAll(".search-bar").forEach((searchBar)=>{
        const searchBarInput = searchBar.children.item(1);
...
document.addEventListener("click", (e)=>{
    const selectedInOverlay = document.getElementById("search-result-overlay").contains(e.target);
    const selectedInSearchBar = Array.from(document.querySelectorAll(".search-bar")).find((el)=>el.contains(e.target));
    // Disable visibility if the checks fail
    if (!selectedInOverlay && !selectedInSearchBar) setSearchVisibility(false);
});
document.addEventListener("scroll", ()=>{
    setSearchVisibility(false);
});

},{"./search-index":"2REft","./main":"ftBBD","@parcel/transformer-js/src/esmodule-helpers.js":"dCOmu"}],"2REft":[function(require,module,exports) {
/**
...
},{}],"ftBBD":[function(require,module,exports) {
/* Defines general variables/properties of the site */ // The path to the current document
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"dCOmu"}]},["782y4"], "782y4", "parcelRequiree125")

//# sourceMappingURL=index.3b69bdcb.js.map
