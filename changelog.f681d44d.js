(function() {
    ...
    x.helper = {
        ...
        "use strict";
        if (!_1.hasOwnProperty(e)) throw Error(e + " flavor was not found");
        x.resetOptions();
        var r, t = _1[e];
        for(r in h1 = e, t)t.hasOwnProperty(r) && (p1[r] = t[r]);
    }, x.getFlavor = function() {
        "use strict";
        return h1;
    }, x.getFlavorOptions = function(e) {
        "use strict";
        if (_1.hasOwnProperty(e)) return _1[e];
    }, x.getDefaultOptions = a1, x.subParser = function(e, r) {
        "use strict";
        if (x.helper.isString(e)) {
            if (void 0 === r) {
                if (t1.hasOwnProperty(e)) return t1[e];
        ...
        if (e = x.helper.stdExtName(e), x.helper.isUndefined(r)) {
            if (d1.hasOwnProperty(e)) return d1[e];
            throw Error("Extension named " + e + " is not registered!");
        }
        "function" == typeof r && (r = r());
        var t = g1(r = x.helper.isArray(r) ? r : [
            r
        ], e);
    ...
    }, x.helper.escapeCharactersCallback = n1, x.helper.escapeCharacters = function(e, r, t) {
        "use strict";
        r = "([" + r.replace(/([\[\]\\])/g, "\\$1") + "])", t && (r = "\\\\" + r), t = new RegExp(r, "g");
        return e = e.replace(t, n1);
    ...
    x.helper.matchRecursiveRegExp = function(e, r, t, a) {
        for(var n = u1(e, r, t, a), s = [], o = 0; o < n.length; ++o)s.push([
        ...
        var s, o = u1(e, t, a, n), t = e, i = o.length;
        if (0 < i) {
            var l = [];
    ...
    }, x.helper.encodeEmailAddress = function(e1) {
        "use strict";
        var t = [
            function(e) {
        ...
        return e1 = e1.replace(/./g, function(e) {
            var r;
        ...
        for(r1 in e2 = e2 || {
        }, p1)p1.hasOwnProperty(r1) && (n2[r1] = p1[r1]);
        if ("object" != typeof e2) throw Error("Converter expects the passed parameter to be an object, but " + typeof e2 + " was passed instead.");
        for(t2 in e2)e2.hasOwnProperty(t2) && (n2[t2] = e2[t2]);
        function c(e, r) {
            if (r = r || null, x.helper.isString(e)) {
                if (r = e = x.helper.stdExtName(e), x.extensions[e]) {
                    ...
                    if ("function" == typeof t && (t = t(new x.Converter)), x.helper.isArray(t) || (t = [
                        t
                    ]), !(a = g1(t, a)).valid) throw Error(a.error);
                ...
                if (x.helper.isUndefined(d1[e])) throw Error('Extension "' + e + '" could not be loaded. It was either not found or is not a valid extension.');
                e = d1[e];
            }
            "function" == typeof e && (e = e());
            a = g1(e = x.helper.isArray(e) ? e : [
                e
            ], r);
        ...
        function u(e, r) {
            ...
            o2.hasOwnProperty(e) || (o2[e] = []), o2[e].push(r);
        }
        n2.extensions && x.helper.forEach(n2.extensions, c), this._dispatch = function(e, r, t, a) {
            if (o2.hasOwnProperty(e)) for(var n = 0; n < o2[e].length; ++n){
                var s = o2[e][n](e, r, this, t, a);
                s && void 0 !== s && (r = s);
            }
            return r;
            ...
            return r = (r = (r = (r = (r = r.replace(/¨/g, "¨T")).replace(/\$/g, "¨D")).replace(/\r\n/g, "\n")).replace(/\r/g, "\n")).replace(/\u00A0/g, "&nbsp;"), n2.smartIndentationFix && (t = (e3 = r).match(/^\s*/)[0].length, t = new RegExp("^\\s{0," + t + "}", "gm"), r = e3.replace(t, "")), r = "\n\n" + r + "\n\n", r = (r = x.subParser("detab")(r, n2, a)).replace(/^[ \t]+$/gm, ""), x.helper.forEach(i2, function(e) {
                r = x.subParser("runExtension")(e, r, n2, a);
            }), r = x.subParser("metadata")(r, n2, a), r = x.subParser("hashPreCodeTags")(r, n2, a), r = x.subParser("githubCodeBlocks")(r, n2, a), r = x.subParser("hashHTMLBlocks")(r, n2, a), r = x.subParser("hashCodeTags")(r, n2, a), r = x.subParser("stripLinkDefinitions")(r, n2, a), r = x.subParser("blockGamut")(r, n2, a), r = x.subParser("unhashHTMLSpans")(r, n2, a), r = (r = (r = x.subParser("unescapeSpecialChars")(r, n2, a)).replace(/¨D/g, "$$")).replace(/¨T/g, "¨"), r = x.subParser("completeHTMLDocument")(r, n2, a), x.helper.forEach(l2, function(e) {
                r = x.subParser("runExtension")(e, r, n2, a);
            }), s2 = a.metadata, r;
        }, this.makeMarkdown = this.makeMd = function(e4, r2) {
            if (e4 = (e4 = (e4 = e4.replace(/\r\n/g, "\n")).replace(/\r/g, "\n")).replace(/>[ \t]+</, ">¨NBSP;<"), !r2) {
            ...
            for(var r2 = r2.createElement("div"), t3 = (r2.innerHTML = e4, {
                preList: function(e) {
            ...
            }(r2), r2.childNodes), n3 = "", s3 = 0; s3 < a3.length; s3++)n3 += x.subParser("makeMarkdown.node")(a3[s3], t3);
            return n3;
            ...
            if (!_1.hasOwnProperty(e)) throw Error(e + " flavor was not found");
            var r, t = _1[e];
            for(r in a2 = e, t)t.hasOwnProperty(r) && (n2[r] = t[r]);
            ...
            for(var r = 0; r < e.length; ++r){
                for(var t = e[r], a = 0; a < i2.length; ++a)i2[a] === t && i2.splice(a, 1);
                for(var n = 0; n < l2.length; ++n)l2[n] === t && l2.splice(n, 1);
            }
    ...
    }, x.subParser("anchors", function(e5, i, l) {
        "use strict";
        function r3(e, r, t, a, n, s, o) {
        ...
        return e5 = (e5 = (e5 = (e5 = (e5 = l.converter._dispatch("anchors.before", e5, i, l)).replace(/\[((?:\[[^\]]*]|[^\[\]])*)] ?(?:\n *)?\[(.*?)]()()()()/g, r3)).replace(/\[((?:\[[^\]]*]|[^\[\]])*)]()[ \t]*\([ \t]?<([^>]*)>(?:[ \t]*((["'])([^"]*?)\5))?[ \t]?\)/g, r3)).replace(/\[((?:\[[^\]]*]|[^\[\]])*)]()[ \t]*\([ \t]?<?([\S]+?(?:\([\S]*?\)[\S]*?)?)>?(?:[ \t]*((["'])([^"]*?)\5))?[ \t]?\)/g, r3)).replace(/\[([^\[\]]+)]()()()()()/g, r3), i.ghMentions && (e5 = e5.replace(/(^|\s)(\\)?(@([a-z\d]+(?:[a-z\d.-]+?[a-z\d]+)*))/gim, function(e, r, t, a, n) {
            if ("\\" === t) return r + a;
        ...
        })), e5 = l.converter._dispatch("anchors.after", e5, i, l);
    });
    var i1 = /([*~_]+|\b)(((https?|ftp|dict):\/\/|www\.)[^'">\s]+?\.[^'">\s]+?)()(\1)?(?=\s|$)(?!["<>])/gi, l1 = /([*~_]+|\b)(((https?|ftp|dict):\/\/|www\.)[^'">\s]+\.[^'">\s]+?)([.!?,()\[\]])?(\1)?(?=\s|$)(?!["<>])/gi, c1 = /()<(((https?|ftp|dict):\/\/|www\.)[^'">\s]+)()>()/gi, m1 = /(^|\s)(?:mailto:)?([A-Za-z0-9!#$%&'*+-/=?^_`{|}~.]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)(?=$|\s)/gim, f1 = /<()(?:mailto:)?([-.\w]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)>/gi;
    x.subParser("autoLinks", function(e, r, t) {
        return e = (e = (e = t.converter._dispatch("autoLinks.before", e, r, t)).replace(c1, s1(r))).replace(f1, o1(r, t)), e = t.converter._dispatch("autoLinks.after", e, r, t);
    }), x.subParser("simplifiedAutoLinks", function(e, r, t) {
        "use strict";
        return r.simplifiedAutoLink ? (e = t.converter._dispatch("simplifiedAutoLinks.before", e, r, t), e = (e = r.excludeTrailingPunctuationFromURLs ? e.replace(l1, s1(r)) : e.replace(i1, s1(r))).replace(m1, o1(r, t)), t.converter._dispatch("simplifiedAutoLinks.after", e, r, t)) : e;
    ...
    }), x.subParser("blockQuotes", function(e6, r4, t) {
        "use strict";
        e6 = t.converter._dispatch("blockQuotes.before", e6, r4, t);
        var a = /(^ {0,3}>[ \t]?.+\n(.+\n)*\n*)+/gm;
        return r4.splitAdjacentBlockquotes && (a = /^ {0,3}>[\s\S]*?(?:\n\n)/gm), e6 = (e6 += "\n\n").replace(a, function(e) {
            return e = (e = (e = e.replace(/^[ \t]*>[ \t]?/gm, "")).replace(/¨0/g, "")).replace(/^[ \t]+$/gm, ""), e = x.subParser("githubCodeBlocks")(e, r4, t), e = (e = (e = x.subParser("blockGamut")(e, r4, t)).replace(/(^|\n)/g, "$1  ")).replace(/(\s*<pre>[^\r]+?<\/pre>)/gm, function(e, r) {
                return r.replace(/^  /gm, "¨0").replace(/¨0/g, "");
            }), x.subParser("hashBlock")("<blockquote>\n" + e + "\n</blockquote>", r4, t);
        }), e6 = t.converter._dispatch("blockQuotes.after", e6, r4, t);
    ...
    }), x.subParser("detab", function(e, r5, t4) {
        "use strict";
        return e = (e = (e = (e = (e = (e = t4.converter._dispatch("detab.before", e, r5, t4)).replace(/\t(?=\t)/g, "    ")).replace(/\t/g, "¨A¨B")).replace(/¨B(.+?)¨A/g, function(e, r) {
            for(var t = r, a = 4 - t.length % 4, n = 0; n < a; n++)t += " ";
            return t;
        })).replace(/¨A/g, "    ")).replace(/¨B/g, ""), e = t4.converter._dispatch("detab.after", e, r5, t4);
    ...
    }), x.subParser("emoji", function(e7, r6, t) {
        "use strict";
        if (!r6.emoji) return e7;
        return e7 = (e7 = t.converter._dispatch("emoji.before", e7, r6, t)).replace(/:([\S]+?):/g, function(e, r) {
            return x.helper.emojis.hasOwnProperty(r) ? x.helper.emojis[r] : e;
        }), e7 = t.converter._dispatch("emoji.after", e7, r6, t);
    ...
    }), x.subParser("escapeSpecialCharsWithinTagAttributes", function(e8, r, t) {
        "use strict";
        return e8 = (e8 = (e8 = t.converter._dispatch("escapeSpecialCharsWithinTagAttributes.before", e8, r, t)).replace(/<\/?[a-z\d_:-]+(?:[\s]+[\s\S]+?)?>/gi, function(e) {
        ...
        }), e8 = t.converter._dispatch("escapeSpecialCharsWithinTagAttributes.after", e8, r, t);
    }), x.subParser("githubCodeBlocks", function(e9, s, o) {
        "use strict";
        return s.ghCodeBlocks ? (e9 = o.converter._dispatch("githubCodeBlocks.before", e9, s, o), e9 = (e9 = (e9 += "¨0").replace(/(?:^|\n)(?: {0,3})(```+|~~~+)(?: *)([^\s`~]*)\n([\s\S]*?)\n(?: {0,3})\1/g, function(e, r, t, a) {
            var n = s.omitExtraWLInCodeBlocks ? "" : "\n";
            return a = x.subParser("encodeCode")(a, s, o), a = "<pre><code" + (t ? ' class="' + t + " language-" + t + '"' : "") + ">" + (a = (a = (a = x.subParser("detab")(a, s, o)).replace(/^\n+/g, "")).replace(/\n+$/g, "")) + n + "</code></pre>", a = x.subParser("hashBlock")(a, s, o), "\n\n¨G" + (o.ghCodeBlocks.push({
                text: e,
                codeblock: a
            }) - 1) + "G\n\n";
        })).replace(/¨0/, ""), o.converter._dispatch("githubCodeBlocks.after", e9, s, o)) : e9;
    ...
    }), x.subParser("hashElement", function(e, r7, t) {
        "use strict";
        return function(e, r) {
            return r = (r = (r = r.replace(/\n\n/g, "\n")).replace(/^\n/, "")).replace(/\n+$/g, ""), r = "\n\n¨K" + (t.gHtmlBlocks.push(r) - 1) + "K\n\n";
        };
    }), x.subParser("hashHTMLBlocks", function(e10, r8, n) {
        "use strict";
        e10 = n.converter._dispatch("hashHTMLBlocks.before", e10, r8, n);
        function t5(e, r, t, a) {
        ...
        r8.backslashEscapesHTMLTags && (e10 = e10.replace(/\\<(\/?[^>]+?)>/g, function(e, r) {
            return "&lt;" + r + "&gt;";
        }));
        for(var s = 0; s < a4.length; ++s)for(var o = new RegExp("^ {0,3}(<" + a4[s] + "\\b[^>]*>)", "im"), i = "<" + a4[s] + "\\b[^>]*>", l = "</" + a4[s] + ">"; -1 !== (c = x.helper.regexIndexOf(e10, o));){
            var c = x.helper.splitAtIndex(e10, c), u = x.helper.replaceRecursiveRegExp(c[1], t5, i, l, "im");
            if (u === c[1]) break;
            e10 = c[0].concat(u);
        }
        return e10 = e10.replace(/(\n {0,3}(<(hr)\b([^<>])*?\/?>)[ \t]*(?=\n{2,}))/g, x.subParser("hashElement")(e10, r8, n)), e10 = (e10 = x.helper.replaceRecursiveRegExp(e10, function(e) {
            return "\n\n¨K" + (n.gHtmlBlocks.push(e) - 1) + "K\n\n";
        }, "^ {0,3}\x3c!--", "--\x3e", "gm")).replace(/(?:\n\n)( {0,3}(?:<([?%])[^\r]*?\2>)[ \t]*(?=\n{2,}))/g, x.subParser("hashElement")(e10, r8, n)), e10 = n.converter._dispatch("hashHTMLBlocks.after", e10, r8, n);
    }), x.subParser("hashHTMLSpans", function(e11, r, t) {
        "use strict";
        function a(e) {
            return "¨C" + (t.gHtmlSpans.push(e) - 1) + "C";
        }
        return e11 = (e11 = (e11 = (e11 = (e11 = t.converter._dispatch("hashHTMLSpans.before", e11, r, t)).replace(/<[^>]+?\/>/gi, a)).replace(/<([^>]+?)>[\s\S]*?<\/\1>/g, a)).replace(/<([^>]+?)\s[^>]+?>[\s\S]*?<\/\1>/g, a)).replace(/<[^>]+?>/gi, a), e11 = t.converter._dispatch("hashHTMLSpans.after", e11, r, t);
        ...
        for(var a = 0; a < t.gHtmlSpans.length; ++a){
            for(var n = t.gHtmlSpans[a], s = 0; /¨C(\d+)C/.test(n);){
                var o = RegExp.$1, n = n.replace("¨C" + o + "C", t.gHtmlSpans[o]);
                if (10 === s) {
    ...
    }), x.subParser("hashPreCodeTags", function(e12, n, s) {
        "use strict";
        e12 = s.converter._dispatch("hashPreCodeTags.before", e12, n, s);
        return e12 = x.helper.replaceRecursiveRegExp(e12, function(e, r, t, a) {
            t = t + x.subParser("encodeCode")(r, n, s) + a;
            return "\n\n¨G" + (s.ghCodeBlocks.push({
                text: e,
                codeblock: t
            }) - 1) + "G\n\n";
        }, "^ {0,3}<pre\\b[^>]*>\\s*<code\\b[^>]*>", "^ {0,3}</code>\\s*</pre>", "gim"), e12 = s.converter._dispatch("hashPreCodeTags.after", e12, n, s);
    }), x.subParser("headers", function(e13, n, s) {
        "use strict";
        e13 = s.converter._dispatch("headers.before", e13, n, s);
        var o = isNaN(parseInt(n.headerLevelStart)) ? 1 : parseInt(n.headerLevelStart), r9 = n.smoothLivePreview ? /^(.+)[ \t]*\n={2,}[ \t]*\n+/gm : /^(.+)[ \t]*\n=+[ \t]*\n+/gm, t6 = n.smoothLivePreview ? /^(.+)[ \t]*\n-{2,}[ \t]*\n+/gm : /^(.+)[ \t]*\n-+[ \t]*\n+/gm, r9 = (e13 = (e13 = e13.replace(r9, function(e, r) {
            var t = x.subParser("spanGamut")(r, n, s), r = n.noHeaderId ? "" : ' id="' + i(r) + '"', r = "<h" + o + r + ">" + t + "</h" + o + ">";
            return x.subParser("hashBlock")(r, n, s);
        })).replace(t6, function(e, r) {
        ...
        return e13 = e13.replace(r9, function(e, r, t) {
        ...
        }), e13 = s.converter._dispatch("headers.after", e13, n, s);
    ...
    }), x.subParser("images", function(e14, r10, d) {
        "use strict";
        function l3(e, r, t, a, n, s, o, i) {
        ...
        return e14 = (e14 = (e14 = (e14 = (e14 = (e14 = d.converter._dispatch("images.before", e14, r10, d)).replace(/!\[([^\]]*?)] ?(?:\n *)?\[([\s\S]*?)]()()()()()/g, l3)).replace(/!\[([^\]]*?)][ \t]*()\([ \t]?<?(data:.+?\/.+?;base64,[A-Za-z0-9+/=\n]+?)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*(?:(["'])([^"]*?)\6)?[ \t]?\)/g, function(e, r, t, a, n, s, o, i) {
            return l3(e, r, t, a = a.replace(/\s/g, ""), n, s, 0, i);
        })).replace(/!\[([^\]]*?)][ \t]*()\([ \t]?<([^>]*)>(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*(?:(?:(["'])([^"]*?)\6))?[ \t]?\)/g, l3)).replace(/!\[([^\]]*?)][ \t]*()\([ \t]?<?([\S]+?(?:\([\S]*?\)[\S]*?)?)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*(?:(["'])([^"]*?)\6)?[ \t]?\)/g, l3)).replace(/!\[([^\[\]]+)]()()()()()/g, l3), e14 = d.converter._dispatch("images.after", e14, r10, d);
    }), x.subParser("italicsAndBold", function(e15, r11, t7) {
        "use strict";
        return e15 = t7.converter._dispatch("italicsAndBold.before", e15, r11, t7), e15 = r11.literalMidWordUnderscores ? (e15 = (e15 = e15.replace(/\b___(\S[\s\S]*?)___\b/g, function(e, r) {
            return "<strong><em>" + r + "</em></strong>";
        })).replace(/\b__(\S[\s\S]*?)__\b/g, function(e, r) {
            return "<strong>" + r + "</strong>";
        })).replace(/\b_(\S[\s\S]*?)_\b/g, function(e, r) {
            return "<em>" + r + "</em>";
        }) : (e15 = (e15 = e15.replace(/___(\S[\s\S]*?)___/g, function(e, r) {
        ...
        }), e15 = r11.literalMidWordAsterisks ? (e15 = (e15 = e15.replace(/([^*]|^)\B\*\*\*(\S[\s\S]*?)\*\*\*\B(?!\*)/g, function(e, r, t) {
            return r + "<strong><em>" + t + "</em></strong>";
        })).replace(/([^*]|^)\B\*\*(\S[\s\S]*?)\*\*\B(?!\*)/g, function(e, r, t) {
            return r + "<strong>" + t + "</strong>";
        })).replace(/([^*]|^)\B\*(\S[\s\S]*?)\*\B(?!\*)/g, function(e, r, t) {
            return r + "<em>" + t + "</em>";
        }) : (e15 = (e15 = e15.replace(/\*\*\*(\S[\s\S]*?)\*\*\*/g, function(e, r) {
            return /\S$/.test(r) ? "<strong><em>" + r + "</em></strong>" : e;
        })).replace(/\*\*(\S[\s\S]*?)\*\*/g, function(e, r) {
            return /\S$/.test(r) ? "<strong>" + r + "</strong>" : e;
        })).replace(/\*([^\s*][\s\S]*?)\*/g, function(e, r) {
            return /\S$/.test(r) ? "<em>" + r + "</em>" : e;
        }), e15 = t7.converter._dispatch("italicsAndBold.after", e15, r11, t7);
    }), x.subParser("lists", function(e16, d, c2) {
        "use strict";
        function p(e17, r12) {
            c2.gListLevel++, e17 = e17.replace(/\n{2,}$/, "\n");
            var t = /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(¨0| {0,3}([*+-]|\d+[.])[ \t]+))/gm, l = /\n[ \t]*\n(?!¨0)/.test(e17 += "¨0");
            return d.disableForced4SpacesIndentedSublists && (t = /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(¨0|\2([*+-]|\d+[.])[ \t]+))/gm), e17 = (e17 = e17.replace(t, function(e18, r, t, a, n, s, o) {
                o = o && "" !== o.trim();
                var n = x.subParser("outdent")(n, d, c2), i = "";
                return s && d.tasklists && (i = ' class="task-list-item" style="list-style-type: none;"', n = n.replace(/^[ \t]*\[(x|X| )?]/m, function() {
                    ...
                    return "¨A" + e;
                }), n = "<li" + i + ">" + (n = (n = r || -1 < n.search(/\n{2,}/) ? (n = x.subParser("githubCodeBlocks")(n, d, c2), x.subParser("blockGamut")(n, d, c2)) : (n = (n = x.subParser("lists")(n, d, c2)).replace(/\n$/, ""), n = (n = x.subParser("hashHTMLBlocks")(n, d, c2)).replace(/\n\n+/g, "\n\n"), (l ? x.subParser("paragraphs") : x.subParser("spanGamut"))(n, d, c2))).replace("¨A", "")) + "</li>\n";
            })).replace(/¨0/g, ""), c2.gListLevel--, e17 = r12 ? e17.replace(/\s+$/, "") : e17;
        }
        function h(e, r) {
            if ("ol" === r) {
                r = e.match(/^ *(\d+)\./);
        ...
        function n4(n, s, o) {
            var e19, i = d.disableForced4SpacesIndentedSublists ? /^ ?\d+\.[ \t]/gm : /^ {0,3}\d+\.[ \t]/gm, l = d.disableForced4SpacesIndentedSublists ? /^ ?[*+-][ \t]/gm : /^ {0,3}[*+-][ \t]/gm, c = "ul" === s ? i : l, u = "";
            return -1 !== n.search(c) ? (function e(r) {
                var t = r.search(c), a = h(n, s);
                -1 !== t ? (u += "\n\n<" + s + a + ">\n" + p(r.slice(0, t), !!o) + "</" + s + ">\n", c = "ul" === (s = "ul" === s ? "ol" : "ul") ? i : l, e(r.slice(t))) : u += "\n\n<" + s + a + ">\n" + p(r, !!o) + "</" + s + ">\n";
            })(n) : (e19 = h(n, s), u = "\n\n<" + s + e19 + ">\n" + p(n, !!o) + "</" + s + ">\n"), u;
        }
        return e16 = c2.converter._dispatch("lists.before", e16, d, c2), e16 += "¨0", e16 = (e16 = c2.gListLevel ? e16.replace(/^(( {0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(¨0|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/gm, function(e, r, t) {
            return n4(r, -1 < t.search(/[*+-]/g) ? "ul" : "ol", !0);
        }) : e16.replace(/(\n\n|^\n?)(( {0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(¨0|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/gm, function(e, r, t, a) {
            return n4(t, -1 < a.search(/[*+-]/g) ? "ul" : "ol", !1);
        })).replace(/¨0/, ""), e16 = c2.converter._dispatch("lists.after", e16, d, c2);
    }), x.subParser("metadata", function(e20, r13, a) {
        "use strict";
        function n(e) {
        ...
        return r13.metadata ? (e20 = (e20 = (e20 = (e20 = a.converter._dispatch("metadata.before", e20, r13, a)).replace(/^\s*«««+(\S*?)\n([\s\S]+?)\n»»»+\n/, function(e, r, t) {
            return n(t), "¨M";
        })).replace(/^\s*---+(\S*?)\n([\s\S]+?)\n---+\n/, function(e, r, t) {
            return r && (a.metadata.format = r), n(t), "¨M";
        })).replace(/¨M/g, ""), a.converter._dispatch("metadata.after", e20, r13, a)) : e20;
    ...
    }), x.subParser("tables", function(e22, y, P) {
        "use strict";
        if (!y.tables) return e22;
        function r14(e23) {
            ...
            if (l.length < c.length) return e23;
        ...
        return e22 = (e22 = (e22 = (e22 = P.converter._dispatch("tables.before", e22, y, P)).replace(/\\(\|)/g, x.helper.escapeCharactersCallback)).replace(/^ {0,3}\|?.+\|.+\n {0,3}\|?[ \t]*:?[ \t]*(?:[-=]){2,}[ \t]*:?[ \t]*\|[ \t]*:?[ \t]*(?:[-=]){2,}[\s\S]+?(?:\n\n|¨0)/gm, r14)).replace(/^ {0,3}\|.+\|[ \t]*\n {0,3}\|[ \t]*:?[ \t]*(?:[-=]){2,}[ \t]*:?[ \t]*\|[ \t]*\n( {0,3}\|.+\|[ \t]*\n)*(?:\n|¨0)/gm, r14), e22 = P.converter._dispatch("tables.after", e22, y, P);
    }), x.subParser("underline", function(e24, r15, t) {
        "use strict";
        return r15.underline ? (e24 = t.converter._dispatch("underline.before", e24, r15, t), e24 = (e24 = r15.literalMidWordUnderscores ? (e24 = e24.replace(/\b___(\S[\s\S]*?)___\b/g, function(e, r) {
            return "<u>" + r + "</u>";
        })).replace(/\b__(\S[\s\S]*?)__\b/g, function(e, r) {
            return "<u>" + r + "</u>";
        }) : (e24 = e24.replace(/___(\S[\s\S]*?)___/g, function(e, r) {
            return /\S$/.test(r) ? "<u>" + r + "</u>" : e;
        })).replace(/__(\S[\s\S]*?)__/g, function(e, r) {
            return /\S$/.test(r) ? "<u>" + r + "</u>" : e;
        })).replace(/(_)/g, x.helper.escapeCharactersCallback), t.converter._dispatch("underline.after", e24, r15, t)) : e24;
    }), x.subParser("unescapeSpecialChars", function(e, r16, t) {
        "use strict";
        return e = (e = t.converter._dispatch("unescapeSpecialChars.before", e, r16, t)).replace(/¨E(\d+)E/g, function(e, r) {
            r = parseInt(r);
            return String.fromCharCode(r);
        }), e = t.converter._dispatch("unescapeSpecialChars.after", e, r16, t);
...
//# sourceMappingURL=changelog.f681d44d.js.map
