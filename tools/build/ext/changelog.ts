...
export function registerChangelogFixExtension(
  showdown: { extension: (name: string, func: () => Array<object>) => void }
): void {
    ...
    return [
      {
        ...
        filter: (text: string) => {
          return text
            .replace(/<p><details>/g, "<details>").replace(/<\/details><\/p>/g, "</details>")
            .replace(/<p><summary>/g, "<summary>").replace(/<\/summary><\/p>/g, "</summary>");
        },
      },
    ];
  });
